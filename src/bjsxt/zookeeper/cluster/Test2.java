...
public class Test2 {
	...
	/** zookeeper地址 */
	static final String CONNECT_ADDR = "192.160.79.134:2181,192.160.79.135:2181,192.160.79.136:2181";
	/** session超时时间 */
	...
	public static void main(String[] args) throws Exception{
		...
		String s = zk.create("/super/c3", "abc".getBytes(), Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
...
//		zk.delete("/super/c3", -1);
		...
		zk.delete("/super/c3", -1, new AsyncCallback.VoidCallback() {
			@Override
